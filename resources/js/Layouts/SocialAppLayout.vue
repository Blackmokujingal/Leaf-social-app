...
<template>
    ...
    <div class="fixed w-full">
        <div class="max-w-[1400px] flex mx-auto">
                ...
                <div class="border-gray-800 border-b w-full">
                    ...
                    <div class="flex">
                        <div
                            ...
                            <div class="inline-block text-center border-b-4 border-b-[#1a7a33] h-[60px]">
            ...
            <!-- The Trending News Side Section  -->
                        ...
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">
                                    Follow the event with ESPN LIVE
                                </div>
                            </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[17px]">
                                    The inflation rate will stay arround 6.2%
                                    according to the BCE
                                </div>
                                <div class="text-[14px] text-gray-400">
                                    8.943 Leaves
                                </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[17px]">
                                    Jon Jones vs Cyril Gane for the Heavyweight
                                    Championship
                                </div>
                                <div class="text-[14px] text-gray-400">
                                    325.210 Leaves
    ...
    <!-- The Comment Overlay Section -->
    <div id="OverlaySection" v-if="createTweet"
        class="fixed top-0 left-0 w-full h-screen bg-[#07070c] md:bg-gray-400 md:bg-opacity-30 md:p-3">
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-[#07070c]">
            <div class="flex items-center justify-between md:inline-block p-2 m-2 rounded-full cursor-pointer">
                ...
                <button :class="
                    tweet
                        ? 'bg-[#1a7a33] text-white'
                        : 'bg-[#052605] text-gray-400'
                " :disabled="!tweet" @click="addTweet()"
                ...
                <div class="w-[calc(100%-100px)]">
                    <div class="inline-block">
                        <div class="flex items-center border border-gray-700 rounded-full">
                            <span class="text-[#1a7a33] p-0.5 pl-3.5 font-extrabold">
                                Everyone
                            </span>
                            <ChevronDown class="pr-2" fillColor="#1a7a33" :size="25" />
                        </div>
                    </div>
                    <div>
                        <textarea :oninput="textareaInput" cols="30" rows="4" placeholder="Leaf your thoughts"
                            v-model="tweet" ref="textarea"
                            class="w-full bg-[#07070c] border-0 mt-2 focus:ring-0 text-white text-[19px] font-extrabold min-h-[120px]">
                            </textarea>
                        <div class="w-full">
                        ...
                        <div class="flex py-2 items-center text-[#1a7a33] font-extrabold">
                            <Earth class="pr-2" fillColor="#1a7a33" :size="20" />
                            Everyone can reply
                        </div>
                            ...
                            <div class="flex items-center">
                                <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                                    <label for="fileUpload" class="cursor-pointer">
                                        <ImageOutline fillColor="#1a7a33" :size="25" />
                                    </label>
                                    <input type="file" id="fileUpload" class="hidden" @change="getFile" />
                                </div>
                                <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                                    <FileGifBox fillColor="#1a7a33" :size="25" />
                                </div>
                                <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                                    <Emoticon fillColor="#1a7a33" :size="25" />
                                </div>
                            </div>
                            <button :class="
                                tweet
